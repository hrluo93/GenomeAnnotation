...
EVidenceModeler-1.1.1/EvmUtils/partition_EVM_inputs.pl --genome sp.masked.fasta --protein_alignments prot.evm.gff --gene_predictions ab.evm.gff --transcript_alignments sptranscripts.fasta.transdecoder.genome.gff3 --segmentSize 100000 --overlapSize 10000 --partition_listing partitions_list.out
EVidenceModeler-1.1.1/EvmUtils/write_EVM_commands.pl --genome sp.masked.fasta --protein_alignments prot.evm.gff --gene_predictions ab.evm.gff --transcript_alignments sptranscripts.fasta.transdecoder.genome.gff3 --weights full/path/weights.txt --output_file_name evm.out  --partitions partitions_list.out >  commands.list
